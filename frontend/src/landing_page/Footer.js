...
function Footer() {
    return (
        <div className='container border-top mt-5' style={{ backgroundColor: "#f8f9fa", padding: "20px" }}>
            <div className='row mt-5'>
                <div className='col'>
                    <img src='Media/logo.svg' alt="Logo" style={{ width: "80%", margin: "auto", padding: "20px" }} />
                    <p className='fs-0.75rem '>&copy; 2010 - 2025, Zerodha Broking Ltd.All rights reserved.</p>
                </div>
                <div className='col '>
                    <p>Account</p>

                    <a href='' className='text-muted mb-5' style={{ textDecoration: "none", marginBottom:"20px"}}>Minor demat account</a><br />
                    <a href='' className='text-muted mb-5' style={{ textDecoration: "none", marginBottom:"10px"}}>NRI demat account</a><br />
                    <a href='' className='text-muted mb-5' style={{ textDecoration: "none", marginBottom:"10px"}}>Commodity</a><br />
                    <a href='' className='text-muted mb-5' style={{ textDecoration: "none", marginBottom:"10px"}}>Open demat account</a><br />
                    <a href='' className='text-muted mb-5' style={{ textDecoration: "none", marginBottom:"10px"}}>Dematerialisation</a><br />
                    <a href='' className='text-muted mb-5' style={{ textDecoration: "none", marginBottom:"10px"}}>Fund transfer</a><br />
                    <a href='' className='text-muted mb-5' style={{ textDecoration: "none", marginBottom:"10px"}}>MTF</a><br />
                    <a href='' className='text-muted mb-5' style={{ textDecoration: "none", marginBottom:"10px"}}>Referral program</a><br />
            ...
            <p>Zerodha Broking Ltd.: Member of NSE, BSE​ &​ MCX SEBI Registration no.: INZ000031633 CDSL/NSDL:
                ...
                Zerodha Commodities Pvt. Ltd. MCX: 46025; NSE-50001  SEBI Registration no.: INZ000038238 Registered Address:
            ...
            <p>"Prevent unauthorised transactions in your account. Update your mobile numbers/email IDs with your stock brokers.
                ...
                make payment in case of allotment. In case of non allotment the funds will remain in your bank account. As a business we don't give
